...
//     const endpoint = isStudent ? "/student/login" : "/professor/login";
...
//         localStorage.setItem("role", isStudent ? "student" : "professor");
        
//         // Set authorization header for future requests
//         axios.defaults.headers.common['Authorization'] = `Bearer ${accessToken}`;
        
//         router.push(isStudent ? "/student/dashboard" : "/professor/dashboard");
//       } else {
...
//         {error && (
//           <div className="mb-4 p-3 bg-red-500 bg-opacity-60 text-white rounded-lg text-center">
//             {error}
//           </div>
//         )}
...
=======
        ...
        <div>
          <h1 className="text-purple-600 font-bold  text-5xl text-center">SMART CLASS</h1>
        </div>

        <h2 className="text-3xl text-gray-600 font-bold text-center mb-2 mt-6">Welcome Back</h2>
>>>>>>> af0fcc9 (changes done)
        <p className="text-center mb-6 text-gray-100">
          Enter your credentials to access your account
        </p>
